    ...
    <div className="min-h-screen bg-background overflow-x-hidden pt-16">
      ...
      <footer className="border-t border-border/40 py-8 mt-12">
        <div className="container px-4 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2">© 2026 Stream Radar. Todos os direitos reservados. · <a href="/politica-de-privacidade" className="text-primary hover:underline">Política de Privacidade</a></p>
        </div>
      </footer>
